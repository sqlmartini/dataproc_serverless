CREATE TABLE adventureworks_raw.Product
(
    ProductID INTEGER
    , Name STRING
...
CREATE TABLE adventureworks_raw.ProductCategory
(
...
CREATE TABLE adventureworks_raw.ProductSubcategory
(
    ProductSubcategoryID INTEGER
    , ProductCategoryID INTEGER    
    , Name STRING
...
CREATE TABLE adventureworks_raw.SalesOrderDetail
(
...
CREATE TABLE adventureworks_raw.SalesOrderHeader
(
    SalesOrderID INTEGER
...
CREATE TABLE adventureworks_raw.SalesTerritory
(
    TerritoryID INTEGER
    , Name STRING
